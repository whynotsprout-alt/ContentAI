...
from contentai.core.hotspot_sources import (
    AIHOT_SOURCE,
    RSS_HOTSPOT_SOURCES,
...
from contentai.integrations.hotspot import hotspot_integration
...
def fetch_hotspots(source: str = "all", platforms: str = "all", rss_sources: str = "all") -> dict:
    ...
    try:
        filtered = filter_hotspot_candidates(
            ...
            callbacks=runtime.model_usage_callbacks("hotspot_filter"),
        )
