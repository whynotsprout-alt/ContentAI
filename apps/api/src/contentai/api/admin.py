...
from contentai.models.schemas.base import AwareDatetime
from contentai.services.auth_service import AuthServiceError
from contentai.services.errors import InvalidCursorError, ResponseItemTooLargeError
from contentai.services.model_config_network import ModelProbeError
from contentai.services.model_configuration_repository import ModelConfigurationChanged
...
def _model_configuration_response(active) -> ModelConfigurationResponse:
    ...
    return ModelConfigurationResponse(
        ...
        output_price_per_million_usd=float(configuration.output_price_per_million_usd),
